...
function Icon({ name, size = 20, color = 'currentColor', sw = 2 }) {
  ...
  const paths = {
    ...
    lock: <><rect x="4.5" y="10.5" width="15" height="10" rx="2.4" /><path d="M8 10.5V8a4 4 0 0 1 8 0v2.5" /></>,
    receipt: <><path d="M5 3v18l2.5-1.6L10 21l2-1.6L14 21l2.5-1.6L19 21V3l-2.5 1.6L14 3l-2 1.6L10 3 7.5 4.6Z" /><path d="M9 8h6M9 12h6" /></>,
    layers: <><path d="M12 3 3 8l9 5 9-5-9-5Z" /><path d="M3 13l9 5 9-5" /></>,
    list: <><path d="M8 6h12M8 12h12M8 18h12" /><circle cx="4" cy="6" r="1" fill={color} stroke="none" /><circle cx="4" cy="12" r="1" fill={color} stroke="none" /><circle cx="4" cy="18" r="1" fill={color} stroke="none" /></>,
    arrowRows: <><path d="M4 7h11M4 7l3-3M4 7l3 3" /><path d="M20 17H9M20 17l-3-3M20 17l-3 3" /></>,
  };
...
function BottomNav({ tab, onTab, onFab, hasCarteiras, items: itemsProp }) {
  const items = itemsProp || (hasCarteiras
