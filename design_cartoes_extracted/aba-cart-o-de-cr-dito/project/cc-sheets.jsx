...
// ---------- Menu do botão + ----------
function QuickAddMenu({ onClose, onAdd, onImport, onTransfer, onNewCard, onCardExpense }) {
  ...
  return (
    <Sheet onClose={onClose} max={480}>
      <div style={{ display: 'grid', gap: 10 }}>
        ...
        {item('card', '#FBBF24', 'Novo cartão de crédito', 'Limite, fatura e vencimento', () => { onClose(); onNewCard && onNewCard(); })}
        {item('down', '#F59E0B', 'Gasto no cartão', 'Lançar compra na fatura', () => { onClose(); onCardExpense && onCardExpense(); })}
